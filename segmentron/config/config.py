...
class SegmentronConfig(dict):
    ...
    def update_from_file(self, config_file):
        ...
        dir = loaded_cfg['VISUAL']['OUTPUT_DIR']
        loaded_cfg['TRAIN']['MODEL_SAVE_DIR']=os.path.join(dir, os.path.splitext(os.path.basename(config_file))[0])
        loaded_cfg['TRAIN']['LOG_SAVE_DIR']=os.path.join(dir, os.path.splitext(os.path.basename(config_file))[0])
        loaded_cfg['VISUAL']['OUTPUT_DIR']=os.path.join(dir, os.path.splitext(os.path.basename(config_file))[0])
