...
# train crop size
cfg.TRAIN.CROP_SIZE = None
# train base size
cfg.TRAIN.BASE_SIZE = None
# model output dir
...
cfg.VISUAL.OUTPUT_DIR = cfg.TRAIN.MODEL_SAVE_DIR
...
# add for semi
cfg.CUDNN.DETEMINISTIC=True
cfg.CUDNN.BENCHMARK=True
cfg.DATASET.TRAIN_SPLIT='train'
cfg.DATASET.VAL_SPLIT='val'
cfg.PIPELINES.TRAIN_PIPELINES = None
cfg.PIPELINES.VAL_PIPELINES = None
cfg.PIPELINES.TEST_PIPELINES = None

cfg.TRAIN.MAX_ITERS = None
cfg.TRAIN.SUMMARY_LOG_ITERS = 300

cfg.SOLVER.REGULAR_MINE.USING = False
cfg.SOLVER.REGULAR_MINE.WIGHT_DECAT = 1e-5
cfg.SOLVER.REGULAR_MINE.REGULAR_PRETRAINED_PATH = ''
cfg.TEST.SIZES = None
cfg.TEST.LONG_SIZES = None
cfg.TEST.TEST_SPLIT = 'val'
cfg.TEST.MODE = 'testval'
cfg.TEST.SAVE_PREDICTION = False
cfg.TEST.COMPUTE_METRIC = True
cfg.TEST.SAVE_PREDICTION_PATH = 'runs/images'
cfg.TEST.SAVE_PREDICTION_NPY_PATH = ''
cfg.MODEL.BN_IS_TRAINING_FOR_ENCODER = True
cfg.MODEL.BN_IS_TRAINING_FOR_DECODER = True

cfg.DATASET.SEMI.TRAIN_SPLIT_U='train'
cfg.DATASET.SEMI.TRAIN_SPLIT_L='train'
cfg.DATASET.SEMI.VAL_SPLIT='val'
cfg.PIPELINES.SEMI.TRAIN_PIPELINES_U = None
cfg.PIPELINES.SEMI.TRAIN_PIPELINES_L = None
cfg.PIPELINES.SEMI.VAL_PIPELINES = None
cfg.PIPELINES.SEMI.TEST_PIPELINES = None
cfg.TRAIN.SEMI.BATCH_SIZE_U = 1
cfg.TRAIN.SEMI.BATCH_SIZE_L = 1
cfg.TRAIN.SEMI.CROP_SIZE = (512, 1024)

cfg.TRAIN.SEMI.Magnitude = 20
cfg.TRAIN.SEMI.max_Magnitude = 40
cfg.TRAIN.SEMI.Numbers = 3
cfg.TRAIN.SEMI.Prob = 1.0
cfg.TRAIN.USING_DSBN=False
cfg.TRAIN.SEMI.DSBN_SIZE=2

cfg.TRAIN.VAL_PRE_ITERS = None

cfg.SOLVER.CEAndSCELoss.ALPHA = 1.0
cfg.SOLVER.CEAndSCELoss.BATE = 0.5
cfg.SOLVER.CEAndSCELoss.USING_WEIGHT = True
